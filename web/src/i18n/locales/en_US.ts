...
const translations: VariantResource = {
  ...
  Settings_Global_SyncProvider: 'Sync Provider',
  Settings_Global_SyncProviderInfo: 'Select the cloud provider for synchronizing bookmarks and settings across devices',
  Settings_Global_SyncProvider_None: 'None (disabled)',
  Settings_Global_SyncProvider_Gist: 'GitHub Gist',
  Settings_Global_SyncProvider_WebDAV: 'WebDAV',
  Settings_Global_SyncToken: 'GitHub Token',
  Settings_Global_SyncTokenInfo: 'Personal access token with gist scope for GitHub Gist sync',
  Settings_Global_SyncWebDAVUrl: 'WebDAV URL',
  Settings_Global_SyncWebDAVUrlInfo: 'Full URL to the sync file (e.g., https://example.com/dav/hakuneko-sync.json)',
  Settings_Global_SyncWebDAVUser: 'WebDAV Username',
  Settings_Global_SyncWebDAVUserInfo: 'Username for WebDAV basic auth (leave empty for anonymous)',
  Settings_Global_SyncWebDAVPass: 'WebDAV Password',
  Settings_Global_SyncWebDAVPassInfo: 'Password for WebDAV basic auth',
  Settings_Global_SyncAuto: 'Auto Sync',
  Settings_Global_SyncAutoInfo: 'Automatically push changes to the cloud after 2 seconds of inactivity',
  Settings_Global_SyncInterval: 'Sync Interval',
  Settings_Global_SyncIntervalInfo: 'Interval in seconds for periodic background sync (requires provider)',
  Settings_Global_SyncEncryption: 'Encrypt Sync Data',
  Settings_Global_SyncEncryptionInfo: 'Encrypt sync payload with passphrase (AES-GCM)',
  Settings_Global_SyncPassphrase: 'Sync Passphrase',
  Settings_Global_SyncPassphraseInfo: 'Passphrase used to encrypt/decrypt sync data when encryption is enabled',
  //
