...
const translations: VariantResource = {
  ...
  Frontend_Classic_Sidenav_Translate: 'Translate',
  Frontend_Classic_Sidenav_LocalFolder: 'Local Folder',
  Frontend_Viewer_OpenInTranslate: 'Open in Translate tab',
  Frontend_Translate_Title: 'Translate',
  Frontend_Translate_Empty: 'No pages yet. Open a chapter in the reader and press "Open in Translate tab", or open a local folder.',
  Frontend_Translate_TranslatePage: 'Translate page',
  Frontend_Translate_TranslateAll: 'Translate whole chapter',
  Frontend_Translate_Translating: 'Translating…',
  Frontend_Translate_Stop: 'Stop',
  Frontend_Translate_ResetAI: 'Reset to AI version',
  Frontend_Translate_ShowOriginal: 'Hold to view original',
  Frontend_Translate_Edited: 'edited',
  Frontend_Translate_Original: 'Original',
  Frontend_Translate_Translated: 'Translated',
  Frontend_Translate_ConfirmAll_Title: 'Translate whole chapter?',
  Frontend_Translate_ConfirmAll_Body: 'This will translate all pages one by one and may use a lot of API quota. Continue?',
  Frontend_Translate_Setup_Title: 'Setup translation (1 minute)',
  Frontend_Translate_Setup_Provider: 'Translation service',
  Frontend_Translate_Setup_Key: 'API key',
  Frontend_Translate_Setup_Test: 'Test connection',
  Frontend_Translate_Setup_Done: 'Done',
  Frontend_Translate_Setup_TryFree: 'Try without key (free, lower quality)',
  Frontend_Translate_Setup_NeedKey: 'This service needs an API key. Paste it above, or try the free option.',
  Frontend_Translate_Setup_TestOK: 'Connection OK, ready to translate!',
  Frontend_Translate_Setup_TestFail: 'Connection failed. Check the provider and key, then try again.',
  Frontend_LocalFolder_Title: 'Local Folder',
  Frontend_LocalFolder_Open: 'Open folder',
  Frontend_LocalFolder_Empty: 'No images here yet. Press "Open folder" and pick a folder with manga pages.',
  Frontend_LocalFolder_View: 'View',
  Frontend_LocalFolder_Translate: 'Translate',
  ...
  Settings_Global_AIProvider: 'AI Translation Provider',
  Settings_Global_AIProviderInfo: 'Select the external AI service for translating UI and manga titles. Your API key is required.',
  Settings_Global_AIProvider_None: 'None (disabled)',
  ...
  Settings_Global_AIModel: 'AI Model',
  Settings_Global_AIModelInfo: 'Model identifier (e.g., gpt-4o-mini, gemini-1.5-flash)',
  Settings_Global_AIKey: 'AI API Key',
  Settings_Global_AIKeyInfo: 'Your personal API key for the selected AI provider (stored encrypted)',
  Settings_Global_AITargetLanguage: 'AI Target Language',
  Settings_Global_AITargetLanguageInfo: 'Language to translate content into (e.g., Vietnamese)',
  Settings_Global_AIAutoTranslate: 'Auto Translate',
  Settings_Global_AIAutoTranslateInfo: 'Automatically translate missing UI strings and manga titles in background (manual button always available)',
  Settings_Global_OCRProvider: 'OCR Provider',
  Settings_Global_OCRProviderInfo: 'Select the engine for recognizing text inside manga images (bubble overlay). Manual per-page button only.',
  Settings_Global_OCRProvider_None: 'None (disabled)',
  ...
  Settings_Global_OCRLanguage: 'OCR Language',
  Settings_Global_OCRLanguageInfo: 'Auto detects Japanese/Korean/Chinese/English, target is Vietnamese',
  Settings_Global_OCROverlay: 'OCR Overlay',
  Settings_Global_OCROverlayInfo: 'Bubble overlay covers original text with Vietnamese translation',
  //
