...
export enum EngineResourceKey {
    ...
    Settings_Global_SyncProvider = 'Settings_Global_SyncProvider',
    Settings_Global_SyncProviderInfo = 'Settings_Global_SyncProviderInfo',
    Settings_Global_SyncProvider_None = 'Settings_Global_SyncProvider_None',
    Settings_Global_SyncProvider_Gist = 'Settings_Global_SyncProvider_Gist',
    Settings_Global_SyncProvider_WebDAV = 'Settings_Global_SyncProvider_WebDAV',
    Settings_Global_SyncToken = 'Settings_Global_SyncToken',
    Settings_Global_SyncTokenInfo = 'Settings_Global_SyncTokenInfo',
    Settings_Global_SyncWebDAVUrl = 'Settings_Global_SyncWebDAVUrl',
    Settings_Global_SyncWebDAVUrlInfo = 'Settings_Global_SyncWebDAVUrlInfo',
    Settings_Global_SyncWebDAVUser = 'Settings_Global_SyncWebDAVUser',
    Settings_Global_SyncWebDAVUserInfo = 'Settings_Global_SyncWebDAVUserInfo',
    Settings_Global_SyncWebDAVPass = 'Settings_Global_SyncWebDAVPass',
    Settings_Global_SyncWebDAVPassInfo = 'Settings_Global_SyncWebDAVPassInfo',
    Settings_Global_SyncAuto = 'Settings_Global_SyncAuto',
    Settings_Global_SyncAutoInfo = 'Settings_Global_SyncAutoInfo',
    Settings_Global_SyncInterval = 'Settings_Global_SyncInterval',
    Settings_Global_SyncIntervalInfo = 'Settings_Global_SyncIntervalInfo',
    Settings_Global_SyncEncryption = 'Settings_Global_SyncEncryption',
