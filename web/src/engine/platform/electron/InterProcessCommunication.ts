...
class IPC {
    ...
    Invoke(channel: Channels.LocalFolder.ReadSidecar, dir: string): Promise<string | null>;
    Invoke(channel: Channels.LocalFolder.WriteSidecar, dir: string, content: string): Promise<void>;
